...
<a class="navbar-brand" href="../">Cuidate</a>
    ...
    <div style="margin-right: 500px">
        <h5 style="color: #000; opacity: 0.9;">Connecté en tant que: <?= $nom ?></h5>
    </div>
...
<?php foreach($produits as $produit): ?>
                ...
                <td><?= $produit->nom ?></td>
                <td style="font-weight: bold; color: grey;"><?= $produit->prix ?>€</td>
                <td><?= substr($produit->description, 0, 100); ?>...</td>
                <td><a href="editer.php?id=<?= $produit->id ?>">modifier</a></td>
                </tr>      
<?php endforeach; ?>
